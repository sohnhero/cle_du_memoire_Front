    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-text-secondary mt-1">Journal d&apos;activité de la plateforme</p>
            </div>
                    ...
                    <table className="w-full">
                        <thead>
                            <tr className="border-b border-border-light bg-bg-light/50">
                                <th className="text-left text-xs font-semibold text-text-secondary uppercase px-6 py-4">Action</th>
                                <th className="text-left text-xs font-semibold text-text-secondary uppercase px-6 py-4">Utilisateur</th>
                                ...
                                <th className="text-right text-xs font-semibold text-text-secondary uppercase px-6 py-4">Heure</th>
                            </tr>
                        </thead>
                        <tbody>
                            {logs.map((log, i) => {
