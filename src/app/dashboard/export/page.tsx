...
export default function ExportComingSoonPage() {
    ...
    return (
        <div className="max-w-4xl mx-auto min-h-[75vh] flex flex-col items-center justify-center p-4 sm:p-6 lg:p-12">
            <motion.div
                initial={{ opacity: 0, scale: 0.95, y: 30 }}
                animate={{ opacity: 1, scale: 1, y: 0 }}
                transition={{ duration: 0.6, type: 'spring', bounce: 0.4 }}
                className="w-full max-w-2xl bg-white rounded-[2rem] p-6 sm:p-10 md:p-14 shadow-2xl border border-border-light text-center relative overflow-hidden group"
            >
                ...
                <div className="relative z-10 flex flex-col items-center">
                    ...
                    >
                        ...
                        <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-primary mb-4 sm:mb-6 leading-tight">
                            Génération Automatique <br />
                            <span className="text-transparent bg-clip-text bg-primary">de votre Mémoire</span>
                        </h1>
                        <p className="text-text-secondary leading-relaxed mb-6 sm:mb-10 text-base sm:text-lg">
