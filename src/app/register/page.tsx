            ...
            <div className="min-h-screen flex isolate perspective-[1000px]">
                ...
                <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary via-primary-light to-primary-dark relative overflow-hidden">
                    ...
                    <div className="relative flex flex-col justify-center items-center w-full p-16">
                        <motion.div animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="text-center opacity-0 translate-y-4 transform-gpu backface-hidden will-change-[opacity,transform]">
                    ...
                    >
                        <div className={`w-full transition-all duration-500 ${step === 3 ? 'max-w-5xl' : 'max-w-lg'}`}>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-5">
                                {step === 1 && (
                                    <motion.div animate={{ opacity: 1, x: 0 }} className="space-y-5 opacity-0 translate-x-4 transform-gpu backface-hidden will-change-[opacity,transform]">
                                ...
                                {step === 3 && (
                                    <motion.div animate={{ opacity: 1, x: 0 }} className="space-y-6 w-full opacity-0 translate-x-4 transform-gpu backface-hidden will-change-[opacity,transform]">
